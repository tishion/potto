...
/// {
/// public:
/// 	static const PottoUuid& CLSID() { static PottoUuid
/// _clsid_("a85985be-7639-4d06-838d-e9d30d76785e"); return _clsid_; } 	POTTO_ERROR
/// _InternalQueryInterface(const PottoUuid& iid, void** ppvObject)
/// 	{
